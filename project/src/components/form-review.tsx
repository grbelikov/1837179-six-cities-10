...
function FormReview(): JSX.Element {
  ...
  return (
    <>
      ...
      <textarea onChange={fieldChangeHandle} value={formData.commentArea} name="commentArea" className="reviews__textarea form__textarea" id="review" placeholder="Tell how was your stay, what you like and what can be improved"></textarea>
